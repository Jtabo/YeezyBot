...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexSiege = /^\/siege/; botRegexOW = /^\/ratings/; botRegexCorrect = /^\/correct/; botRegex4th = /^\/4th/; botRegexGiz = /^\ATS/; botRegexPerkins = /^\/perkins/;  
      ...
      botRegexDaf = /^\/dafuq/; botRegexAyy = /^\/ayy/; botRegexSchedule = /^\/schedule/; botRegexHeh = /^\/heh/; botRegexGg = /^\/gg/; botRegexBobby = /^\/bobby/;
